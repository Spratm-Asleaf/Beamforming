...
% Discrete-Valued Transmitting Signal

M = 4;              % Number of transmiting antenna        
N = 32;             % Number of receiving antenna (for fixed M, the larger N, the better due to receiver diversity or data diversity)
...
Kernel_Params.scale = 0.0005;             % Scale of kernel
